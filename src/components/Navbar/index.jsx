...
const Navbar = props => {
  ...
  return (
    <div className='Navbar-container'>
      ...
      {
        props.user.name && location.pathname.slice(0, location.pathname.lastIndexOf('/')) === '/viewPost' ?
          <button onClick={() => history.push('/editPost/' + props.postId)}>Edit Post</button> :
          null
      }
      {
        props.user.name && location.pathname.slice(0, location.pathname.lastIndexOf('/')) === '/viewPost' && props.user.id === props.postAuthor ?
